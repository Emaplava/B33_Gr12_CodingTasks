...
public class Number_DivisibleBy3_5_15 {
    ...
    public static void divisibleNumbers(int n){
        ...
        StringBuilder divBy15 = new StringBuilder("Divisible By 15: ");
        StringBuilder divBy3 = new StringBuilder("Divisible By 3: ");
        StringBuilder divBy5 = new StringBuilder("Divisible By 5: ");
